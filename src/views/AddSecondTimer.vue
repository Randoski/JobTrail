<template>
  <div>
    <h3 class="text-3xl font-semibold text-gray-700">Add Second Timer</h3>
  ...
  methods: {
    ...
    async save() {
      ...
      try {
        ...
        const docRef = await addDoc(collection(db, "second-timer"), formData);
        console.log("Document written with ID: ", docRef.id);
        alert("Second Timer Added Successfully");
