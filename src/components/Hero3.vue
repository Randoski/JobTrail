  ...
  <div>
    ...
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <div class="mt-12 md:mt-0">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-text">Let's create more tools and ideas that brings us together.</h2>
            ...
            <router-link to="/sign-up" class="inline-flex items-center text-white bg-pry hover:bg-pryHover font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
                Get started
