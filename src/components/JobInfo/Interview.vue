          ...
          <form>
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
              ...
              <div @click="activateForm">
                <label class="text-gray-700 text-sm font-bold">Title</label>
                <input
              ...
              <!-- Date -->
              <div @click="activateForm">
                <label class="text-gray-700 text-sm font-bold">Date</label>
                <input
                  class="w-full mt-2 rounded-md focus:border-pry"
                  :class="{
                    'border-transparent': isReadOnly,
              ...
              <!-- Time -->
              <div @click="activateForm">
                <label class="text-gray-700 text-sm font-bold">Time</label>
                <input
                  class="w-full mt-2 rounded-md focus:border-pry"
                  :class="{
                    'border-transparent': isReadOnly,
              ...
              <!-- Status -->
              <div @click="activateForm">
                <label class="text-gray-700 text-sm font-bold">Status</label>
                <select
...
export default {
  data() {
    return {
      isReadOnly: true,
      test: "Sample",
      statuses: ["Pending", "Cancelled", "Postponed", "Attended"],
    };
  },
  methods: {
    toggleEdit() {
