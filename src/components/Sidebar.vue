<template>
  <div class="flex">
    ...
    <div :class="isOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
      ...
      <div class="ml-5 mt-8">
        <router-link to="/dashboard" class="mx-2 text-xl font-extrabold text-white">JobTrail</router-link>
      </div>
      ...
      <nav class="mt-12">
        ...
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4">Explore Jobs <span
              class="text-xs font-light  ml-1 px-1 bg-sec rounded-full">Beta</span></span>
        </router-link>
